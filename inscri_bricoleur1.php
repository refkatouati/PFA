            ...
            <div class="row">
                ...
                <h1 class="typo-list">INFORMATIONS PERSONNELLES</h1>
                    <form method="POST" action="add_bricoleur.php">
                        ...
                        <div class="mt-10">
                           Age: <input type="date" name="date" placeholder="date" onfocus="this.placeholder = ''"
                        ...
                        <div class="input-group-icon mt-10">
                        Select profil picture to upload:<input type="file" name="image" placeholder="img" onfocus="this.placeholder = ''"
                            onblur="this.placeholder = 'img'" required class="single-input">
